...
const TopPicks = () => {
  return (
    <>
      <h1 className='text-purple-500 font-bold text-2xl text-center py-2'>Top Picks</h1>
      <div className='hidden lg:flex max-w[1520px] m-auto py-2 px-2'>
        <Splide options={{perPage: 3, gap:"1rem", grag:'free', arrows:false}}>
        {
            topPicks.map((item)=>{
                return(
                    ...
                    <div className='rounded-3xl relative'>
                        ...
                        <img className=' h-[300px] w-full object-cover rounded-3xl cursor-pointer hover:scale-105 ease-out duration-300' 
