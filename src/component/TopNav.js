  ...
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Hunger
            <span className='font-bold'>Hub</span>
        </h1>
        <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
            <p className='bg-purple-700 text-white rounded-full p-2 text-bold'>Easy</p>
      ...
      <button className='bg-purple-700 text-white hidden md:flex items-center p-2 rounded-full'>
      ...
      >
        ...
        <h2 className='text-2xl p-4 '>Hunger <span className='text-purple-700 font-bold'>Hub</span></h2>
        <nav>
